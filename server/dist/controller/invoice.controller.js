...
var invoice_controller_exports = {};
__export(invoice_controller_exports, {
  CreateInvoice: () => CreateInvoice,
  deletInvoice: () => deletInvoice,
  getAllInvoice: () => getAllInvoice,
  getAllSingleQuery: () => getAllSingleQuery
});
module.exports = __toCommonJS(invoice_controller_exports);
